...
class arcade:
    ...
    def UI(arcade):
        ...
        selections = [
            ...
            UI_font2.render('8: Alphabet', False, white)
                      ]
        ...
        while True:
            ...
            if pressed[K_8] or pressed[K_KP8] or (mouse_click and selections_rects[7].collidepoint(mouse_pos)): game = 'Alphabet'; import_module('Alphabet').game(arcade)
